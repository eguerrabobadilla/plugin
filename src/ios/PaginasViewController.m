...
@interface PaginasViewController ()
...
{
    NSString *pagina= [_Indice objectAtIndex:indexPath.row];
    //NSString *peticion=[NSString stringWithFormat:@"Visor.handleIndiceNative('%@')",pagina];
    NSString *peticion=[NSString stringWithFormat:@"IDRViewer.goToPage(%@)",pagina];
